...
for index in surveyData {
    tabulator.incrementCount(forValue: index)

}
// Loop through the tallied shows (stored in tabulator.values), printing the information from each one.
//for stored in tabulator.values {
//    print("\(stored): \(tabulator.count(forValue: stored))")
//}
/*:
...
//for index in surveyData {
//    print(tabulator.count(forValue: index))
//}
var totalA = 0
var totalB = 0
